interface EXIFStatic {
    ...
    getAllIptcTags(img: ExifImage): {[key: string]: string};
    pretty(img: ExifImage): string;
    readFromBinaryFile(file: any): boolean;

    Tags: {[key: string]: string};
    TiffTags: {[key: string]: string};
    GPSTags: {[key: string]: string};
    IFD1Tags: {[key: string]: string};
    StringValues: {
        ExposureProgram : {
            0: "Not defined";
            1: "Manual";
